...
public interface Constants {
	 ...
	 * <ul>
	 * <li>{@link #PAREMUS_SCOPE_UNIVERSAL} - Advertise this service
	 * everywhere</li>
	 * <li>{@link #PAREMUS_SCOPE_GLOBAL} - Advertise this service to all members
	 * within the default local group</li>
	 * <li>{@link #PAREMUS_SCOPE_TARGETTED} - Advertise this service to members
	 * that have the relevant scope</li>
	 * </ul>
	 ...
	 * {@link #PAREMUS_SCOPE_TARGETTED} service. Usually set automatically by
	...
	/**
	 * The UUID of the "origin" framework if different from the Framework UUID
	 * in the the Endpoint Description. This should be set by the topology
	 * manager when exporting a service that has a secondary id (e.g. it is
	 * being exposed via OSGi, or is coming from another framework).
	 */
