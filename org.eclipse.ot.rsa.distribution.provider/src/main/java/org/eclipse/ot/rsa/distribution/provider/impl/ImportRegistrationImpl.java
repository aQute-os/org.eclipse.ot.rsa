...
public class ImportRegistrationImpl implements ImportRegistration {
	...
	private long getServiceTimeout() {
		long serviceTimeout = _config.org_eclipse_ot_rsa_distribution_timeout();
	...
	public boolean update(EndpointDescription endpoint) {
		synchronized (this) {
			...
			if (!Arrays.deepEquals(_config.org_eclipse_ot_rsa_distribution_config_methods(),
				tmpConfig.org_eclipse_ot_rsa_distribution_config_methods())) {
