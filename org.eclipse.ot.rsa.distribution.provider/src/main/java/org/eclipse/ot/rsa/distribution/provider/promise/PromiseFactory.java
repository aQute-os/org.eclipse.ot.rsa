...
public class PromiseFactory {
	...
	private static class CustomPromiseFactory implements Function<EventExecutor, Promise<Object>> {
		...
		private static final String		CUSTOM_IMPL_NAME_V1			= "org.eclipse.ot.rsa.distribution.provider.promise.FuturePromise_v1";
		private static final String		CUSTOM_RESOURCE_NAME_V1		= resourceName(CUSTOM_IMPL_NAME_V1);
