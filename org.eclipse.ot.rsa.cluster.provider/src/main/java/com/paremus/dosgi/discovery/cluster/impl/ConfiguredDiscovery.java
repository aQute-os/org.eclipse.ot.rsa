...
import org.eclipse.ot.rsa.multrsa.api.ClusterDiscovery;
import org.eclipse.ot.rsa.multrsa.api.ScopeManager;
...
@ServiceCapability({ClusterListener.class, EndpointEventListener.class})
...
@Requirement(namespace=IMPLEMENTATION_NAMESPACE, name=ClusterConstants.IMPLEMENTATION_NAMESPACE, version="1.0", effective="active")
