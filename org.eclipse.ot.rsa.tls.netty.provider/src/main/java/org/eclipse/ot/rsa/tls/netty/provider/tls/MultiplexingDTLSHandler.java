...
public interface MultiplexingDTLSHandler extends ChannelHandler {
	 ...
	 * @return a future representing the state of the current handshake, or null
	 *         if no handshake or connection is ongoing
	 */
	...
	/**
	 * Get a collection of all the remote participants with which there are
	 * ongoing handshakes and DTLS sessions
	 * 
