...
public class EndpointEventListenerInterest {
	...
	public EndpointEventListenerInterest(EndpointEventListener listener,
			ServiceReference<?> listenerRef, Object filters) {
	...
	public void updateFilters(Object o) {
		...
		if(oldEd == null && newEd != null) {
			...
			if(oldFilter != null) {
				...
				if(filter != null) {
					...
					listener.endpointChanged(new EndpointEvent(EndpointEvent.MODIFIED_ENDMATCH, newEd), filter);
				}
			} else {
				notify(null, newEd);
			}
